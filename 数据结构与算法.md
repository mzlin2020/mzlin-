...
栈（stack），是一种==受限的线性表==，后见先出（LIFO Last In First Out）
...
```javascript
        ...
        // 方法三
        var res = person.peek()
        console.log(res); //因为44被删除了，所以33

        // 方法四
        var res2 = person.isEmpty()
        console.log(res2);

        // 方法五
        var res3 = person.size()
        console.log(res3);

        // 方法六
        var res4 = person.toString()
        console.log(res4);
```
...
```javascript
        ...
        // 方法三
        var res = people.front()
        console.log(res);

        // 方法四
        var res2 = people.isEmpty()
        console.log(res2);

        // 方法五
        var res3 = people.size()
        console.log(res3);

        // 方法六
        var res4 = people.toString()
        console.log(res4);
```
...
// 面试题：击鼓传花
        ...
        function pastGame(nameList,num){
            ...
            // 3.开始数数字
            while(queue.size() > 1){ //队列中的元素小于等于1时，就会停下来
                // 不是num时，重新加入队列尾部
                // 是num，则将其删除
            ...
            var endName = queue.front() //读取队列剩下来的元素
...
![1618656659979](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1618656659979.png)
